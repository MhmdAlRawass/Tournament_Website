...
//     <TTeam, TScore>(teams: Array<[Option<TTeam>, Option<TTeam>]>, m: number) =>
...
//   const mkMatchConnector =
//     <TTeam, TScore, TMData, TUData>(centerConnectors: boolean) =>
